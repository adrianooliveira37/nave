...
export class Start extends Phaser.Scene {
    ...
    create() {
        ...
        // Aumentando o tamanho dos botões e ajustando a posição
        this.upButton = this.add.sprite(100, 500, 'upButton').setInteractive().setScale(1.5); // Botão maior
        this.downButton = this.add.sprite(100, 650, 'downButton').setInteractive().setScale(1.5); // Botão maior
        this.shootButton = this.add.sprite(1180, 575, 'shootButton').setInteractive().setScale(1.5); // Botão maior

        // Adicionando feedback visual ao tocar nos botões
        this.upButton.on('pointerdown', () => {
            this.ship.y -= 5;
            this.upButton.setScale(1.4); // Efeito de pressionar
        }).on('pointerup', () => {
            this.upButton.setScale(1.5); // Volta ao tamanho original
        });

        this.downButton.on('pointerdown', () => {
            this.ship.y += 5;
            this.downButton.setScale(1.4); // Efeito de pressionar
        }).on('pointerup', () => {
            this.downButton.setScale(1.5); // Volta ao tamanho original
        });

        this.shootButton.on('pointerdown', () => {
            this.shootBullet();
            this.shootButton.setScale(1.4); // Efeito de pressionar
        }).on('pointerup', () => {
            this.shootButton.setScale(1.5); // Volta ao tamanho original
        });
    ...
    create() {
        ...
        // Controles touch para dispositivos móveis
        this.upButton = this.add.sprite(100, 600, 'upButton').setInteractive().setScale(0.5);
        this.downButton = this.add.sprite(100, 700, 'downButton').setInteractive().setScale(0.5);
        this.shootButton = this.add.sprite(1180, 600, 'shootButton').setInteractive().setScale(0.5);
